...
document.querySelector(".cus>button").addEventListener("click", function () {
  if (flag == 1) {
    ...
    document.querySelector(".cus>button").style.backgroundImage =
      "url(./okk.png)";
    ...
    document.querySelector(".rtopin").style.backgroundImage =
      "url(https://i.pinimg.com/originals/ae/b5/2f/aeb52f40ecf9d7b01da4860e74068e97.gif)";
    ...
    document.querySelector(".rtopin").style.backgroundImage =
      "url(https://i.pinimg.com/originals/0b/ce/fc/0bcefc2af75f4683ca0b3d3ad2d46c71.gif)";
    document.querySelector(".rtincontent>h1").style.color = "white";
    ...
    document.querySelector(".rbleft").style.backgroundColor =
      "rgb(245, 149, 165)";
    document.querySelector(".rbright").style.backgroundColor =
      "rgb(212, 212, 119)";
